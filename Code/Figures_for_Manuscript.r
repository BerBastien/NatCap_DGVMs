...
pkgs <- c('raster',"hacksaw", 'ggpubr',"tidyverse",'dplyr','ncdf4','ggplot2','countrycode','tidyverse','RColorBrewer','colorspace','spData','sf','lfe','marginaleffects','rnaturalearth',"scico","writexl","ggsci","cowplot")
...
pal <- brewer.pal(n = 3, name = "RdYlBu")
  ...
  ## Figure 1
  load(file="Figures/DataForFigures/ww.Rds")
  ...
  ggsave(filename="Figures/ManuscriptFigures/F1_vector.pdf", plot=combined_plot, width=10, height=7)
    ...
    ## Figure 2
        load(file="Figures/DataForFigures/PFTs11_horizons3.Rds")
        ...
        load("Figures/DataForFigures/PFT_change.Rds")
        ...
        load(file="Figures/DataForFigures/pft_sum_poly_rob4_lpj.Rds")
        ...
        load("Figures/DataForFigures/cveg_sum_poly_rob4_lpj.Rds")
        dcveg <- ggplot() +
            theme_void() +
    ...
    ## Figure 3
        load("Figures/DataForFigures/pft_es_lpj.Rds") 
        load("Figures/DataForFigures/ES_val_lpj5.Rds")    
        load("Figures/DataForFigures/ES_val_lpj6.Rds")      
        load("Figures/DataForFigures/map_coef.Rds")  
    ...
    ## Figure 4
        ...
        load("Figures/DataForFigures/GR_Results_lpj_traj.Rds")
        load("Figures/DataForFigures/ordered_GR_lpj.Rds")
        load(file="Figures/DataForFigures/ordered_GR_lpj_gdp.Rds")
    ...
    ## Figure ED 2
        load(file="Figures/DataForFigures/elas_data.Rds")
        dat <- elas_data
    ...
    ## Figure ED 4
        load(file="Figures/DataForFigures/PFTs11_horizons3_car.Rds")
        load(file="Figures/DataForFigures/PFT_change_car.Rds")      
        ...
        load(file="Figures/DataForFigures/pft_sum_poly_rob4_car.Rds")
        world_coast <- ne_coastline(scale = "medium", returnclass = "sf")
        d_area <- ggplot() +
            theme_void() +
        ...
        load("Figures/DataForFigures/cveg_sum_poly_rob4_car.Rds")
        dcveg <- ggplot() +
            theme_void() +
    ...
    ## Figure ED 5
        load(file="Figures/DataForFigures/PFTs11_horizons3_orc.Rds")
        load(file="Figures/DataForFigures/PFT_change_orc.Rds")  
        ...
        load(file="Figures/DataForFigures/pft_sum_poly_rob4_orc.Rds")
        world_coast <- ne_coastline(scale = "medium", returnclass = "sf")
        d_area <- ggplot() +
            theme_void() +
        ...
        load("Figures/DataForFigures/cveg_sum_poly_rob4_orc.Rds")
        dcveg <- ggplot() +
            theme_void() +
    ...
    ## Figure ED 6
        load("Figures/DataForFigures/pft_es_car.Rds") 
        load("Figures/DataForFigures/ES_val_car5.Rds")    
        load("Figures/DataForFigures/ES_val_car6.Rds")      
        load("Figures/DataForFigures/map_coef.Rds")  
    ...
    ## Figure ED 7
        load("Figures/DataForFigures/pft_es_orc.Rds") 
        load("Figures/DataForFigures/ES_val_orc5.Rds")    
        load("Figures/DataForFigures/ES_val_orc6.Rds")      
        load("Figures/DataForFigures/map_coef.Rds")
    ...
    ## Figure ED 8
        load("Figures/DataForFigures/GR_Results_traj_orc.Rds")
        ...
        load(file="Figures/DataForFigures/GR_Results_car.Rds")
    ...
    ## Figure ED 9
        load(file="Figures/DataForFigures/GR_Results_lpj.Rds")
        load(file="Figures/DataForFigures/GR_Results_orc.Rds")
        load(file="Figures/DataForFigures/GR_Results_car.Rds")
    ...
    ## Figure ED 10
            load("Figures/DataForFigures/GR_Results_lpj_noS.Rds")
        ...
        load("Figures/DataForFigures/GR_Results_lpj_traj_noS.Rds")
    ...
    ## Figure ED 11
        load(file="Figures/DataForFigures/ordered_GR_dam_lpj.Rds")
        ...
        load("Figures/DataForFigures/GR_Results_car.Rds")
        GR_Results <- GR_Results_car
