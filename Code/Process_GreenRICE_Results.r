#data usef
greenrice_results <- "Results_RICE50x/resultsLinearLPJ.parquet"


#setup#
   pkgs <- c('arrow','raster',"hacksaw", 'ggpubr','dplyr','ncdf4','ggplot2','countrycode','tidyverse','RColorBrewer','colorspace','spData','sf','lfe','marginaleffects','rnaturalearth', 'ggallin','ggbreak','scico')
    ...
    GR_Results <- read_parquet(greenrice_results)
    glimpse(GR_Results)    
