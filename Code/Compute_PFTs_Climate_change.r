#Directory of ISIMIP data
dir_isimip <- "Data_External/VegetationData/"


#create necessary directories if not existing
if(!dir.exists("Figures")) dir.create("Figures")
if(!dir.exists("Figures/ManuscriptFigures")) dir.create("Figures/ManuscriptFigures") 
if(!dir.exists("Figures/DataForFigures")) dir.create("Figures/DataForFigures") 
if(!dir.exists("Data/PFT_rasters")) dir.create("Data/PFT_rasters") 
if(!dir.exists("Data/cveg_rasters")) dir.create("Data/cveg_rasters") 



#setup#
     pkgs <- c('raster',"hacksaw", 'ggpubr','dplyr','ncdf4','ggplot2','countrycode','tidyverse','RColorBrewer','colorspace','spData','sf','lfe','marginaleffects','rnaturalearth')
...
#READ WORLD BANK DATA
    ...
    write.csv(wealth2018,"Data/out/wealth2018.csv")
    ...
    write.csv(wealth_data,"Data/out/wealth_data.csv")
    ...
    Npa_year <- aggregate(Npa ~ year, data = wealth_data, FUN = "sum")
        ...
        #write.csv(table_coefficients,"Data/out/table_coefficients.csv")
        save(ww,file="Figures/DataForFigures/ww.Rds")
...
#Read NetCDF of PFTs (start)
            ...
            #for (dgvmsi in 1:length(dgvms)){
                ...
                for (climi in 1:length(clim_models)){ #climi<- 2
                    for (p in 1:length(pfts)){ #p <- 17
                        ...
                        listoffiles <- list.files(paste0(dir_isimip,"PFTs_",dgvms[dgvmsi],"/"))
                        ...
                        ncname <- paste(dir_isimip,"PFTs_",dgvms[dgvmsi],"/",dgvms_long[dgvmsi],"_",clim_models[climi],"_ewembi_",clim_scen[sceni],"_",soc_scen[soci],"_co2_pft-",pfts[p],"_global_annual_2006_2099.nc4",sep="")
    ...
    #write.csv(df_biome_area_change,"Data/out/biome_area.csv")
    #df_biome_area_change <- read.csv("Data/out/biome_area.csv")
            ...
            for (dgvmsi in 1:length(dgvms)){
                ...
                for (climi in 1:length(clim_models)){
                    for (p in 1:length(pfts)){
                        ...
                        listoffiles <- list.files(paste0(dir_isimip,"cveg_",dgvms[dgvmsi],"/"))
                        ...
                        ncname <- paste(dir_isimip,"cveg_",dgvms[dgvmsi],"/",dgvms_long[dgvmsi],"_",clim_models[climi],"_ewembi_",clim_scen[sceni],"_",soc_scen[soci],"_co2_cveg-",pfts[p],"_global_annual_2006_2099.nc4",sep="")
...
# Plot biome area cover change against temperature (start)
    ...
    model1 <- felm(dif_biome_area ~ 0+ dif_t + I(dif_t^2) + scen + gcm_model + dgvms_model| 0  | 0 | 0  , data=df_biome)
...
# Map of cover change at temperature horizons (start)
        ...
        if (abs(temp$dif_t[decade_i]-temp_level) > 0.3){
            ...
            save(pft_sum_poly_rob4_orc,file="Figures/DataForFigures/pft_sum_poly_rob4_orc.Rds")
        ...
        if (abs(temp$dif_t[decade_i]-temp_level) > 0.3){
            ...
            save(cveg_sum_poly_rob4_orc,file="Figures/DataForFigures/cveg_sum_poly_rob4_orc.Rds")
...
# Plot latitudes
    ...
    horizon <- c("Present","2C")
        ...
        save(a_h,file="Data/out/a_h_3dgvms.Rda")

        
        #load("Data/out/a_h_3dgvms.Rda")
        glimpse(a_h)
        ...
        #save(PFTs11_horizons3,file="Figures/DataForFigures/PFTs11_horizons3.Rds")
        ...
        #save(PFT_change,"Figures/DataForFigures/PFT_change.Rds")
        ...
        #save(PFTs11_horizons3_orc,file="Figures/DataForFigures/PFTs11_horizons3_orc.Rds")
        ...
        save(PFT_change_orc,file="Figures/DataForFigures/PFT_change_orc.Rds")
        ...
        save(PFTs11_horizons3_car,file="Figures/DataForFigures/PFTs11_horizons3_car.Rds")
        Present_dist_col <- ggplot(PFTs11_horizons3)+
        ...
        save(PFT_change_car,file="Figures/DataForFigures/PFT_change_car.Rds")
...
# Get Country Level Data
        ...
        save(a,file="Data/out/PFT_all_data_3dgvms_cveg.Rda")
# Get Country Level Data
        ...
        # Read Database
            ...
            elas_data <- dat 
            save(elas_data,file="Figures/DataForFigures/elas_data.Rds")
...
# Calculate Nat Cap Damage
            load(file="Data/out/PFT_all_data_3dgvms_cveg.Rda") #here
            glimpse(a)
            ...
            # save(NK_allcountries,file="out/Data/NK_allcountries_final_submission3v2_06052023.Rda")
            # save(PFT_ES_all,file="Data/out/PFT_ES_allcountries_final_submission3v2_06052023.Rda")
            
            load("Data/out/NK_allcountries_final_submission3v2_06052023.Rda")
            load("Data/out/PFT_ES_allcountries_final_submission3v2_06052023.Rda")
            glimpse(PFT_ES_all)
            ...
            # Figure ES values per ha
                ...
                save(pft_es_lpj,file="Figures/DataForFigures/pft_es_lpj.Rds")
                ...
                save(pft_es_car,file="Figures/DataForFigures/pft_es_car.Rds")
                ...
                save(pft_es_orc,file="Figures/DataForFigures/pft_es_orc.Rds")
            ...
            #Figure Total Values per Continent
                ...
                ##
                    ...
                    save(ES_val_lpj5,file="Figures/DataForFigures/ES_val_lpj5.Rds")
                    ESValplot 
                    ...
                    GDPValplot <-  ggplot(ES_val_lpj6,aes(x=region_un,y=100*TotalValGDP_gdp,fill=PFT_code))+ #2.32 is adjustement for making up for a bug in the code
                                ...
                                guides(fill = guide_legend(reverse=FALSE)) + ylim(c(0,26))
                    save(ES_val_lpj6,file="Figures/DataForFigures/ES_val_lpj6.Rds")
                ...
                ##
                    ...
                    #save(ES_val_car5,file="Figures/DataForFigures/ES_val_car5.Rds")
                    ...
                    #save(ES_val_car6,file="Figures/DataForFigures/ES_val_car6.Rds")
                    ggarrange(GDPValplot,ESValplot,common.legend=TRUE,legend="none")
                ...
                ##
                    ...
                    save(ES_val_orc5,file="Figures/DataForFigures/ES_val_orc5.Rds")
                    save(ES_val_orc6,file="Figures/DataForFigures/ES_val_orc6.Rds")
            ...
            glimpse(NK)  
            glimpse(tempdecade)
            #save(NK,file="Data/out/DamageNK_Temp.Rda")
            ...
            #save(NK_temp,file="Data/out/DamageNK_Temp.Rda")
           
            #load(file=paste0("Data/out/DamageNK_Temp.Rda"))
        ...
        results_df <- read.csv("Data/Damage_coef_Submission3v2_06052023.csv")
            ...
            w2018 <- data.frame(iso3=wealth2018$countrycode,K=wealth2018$K, 
                    ...
                    glimpse(w2018)
            #write.csv(w2018,file="Data/out/w2018.csv")
            w2018 <- read.csv(w2018,file="Data/out/w2018.csv")
            ...
            save(map_coef,file="Figures/DataForFigures/map_coef.Rds")
